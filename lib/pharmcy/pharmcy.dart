...
TextEditingController search= TextEditingController();
 ...
 CollectionReference user2=FirebaseFirestore.instance.collection('medicineStore');
  CollectionReference user3=FirebaseFirestore.instance.collection('medicalsupplyStore');
   getDateFilter(  ) async{
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      SizedBox(height: 10,),
                    i==0?Text('Mdicine in Store' ,style: text,):Text('Medicine in supply unit' ,style: text),
                      Padding(
...
move_to_page(BuildContext ctx, index) {
  ...
  switch (index) {
    ...
    case 2:
      Navigator.of(ctx)
          .push(MaterialPageRoute(builder: (_) => addMedicinInStoreStatefull()));
      break;
    case 3:
      Navigator.of(ctx)
          .push(MaterialPageRoute(builder: (_) => addMedicinInsuppliesStatefull()));
      break;
  }
}
