...
class addsuppliesInSuppliesUnitStatefull extends StatefulWidget {
  @override
  _addsuppliesInSuppliesUnitState createState() => _addsuppliesInSuppliesUnitState();
}
// class selectedDate{
//   DateTime ?Date = null;
//   bool flag = false;
...
class _addsuppliesInSuppliesUnitState extends State<addsuppliesInSuppliesUnitStatefull> {
  // def() {
  //   print("object");
  // }
 var name = TextEditingController();
  ...
  CollectionReference user1=  FirebaseFirestore.instance.collection('medicalsupplyStore');
  CollectionReference user2=  FirebaseFirestore.instance.collection('medicalsupplyUnit');
    ...
    value.docs.forEach((element) { 
      ...
      if(data['Name']==name){
        ...
        setState(() {
           ...
           print("================================");
             user1.doc(id).update({
           'quantity':data['quantity']-num.parse(quantity)
  });
       print(id);
              ...
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () async{
                    ...
                    await UpdateUnit(name.text,quantity.text , num.parse(code.text), details.text, Date);
                       setState(() {
